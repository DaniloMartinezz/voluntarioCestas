    ...
    <div className="container mx-auto p-4 md:p-10 mt-16">
      <div className="bg-white rounded-lg shadow-lg p-6 md:p-10">
        ...
        <div className="mt-10 bg-gray-100 p-6 rounded-lg shadow-inner">
          ...
          <p className="text-center text-base text-gray-700">Utilize o QR Code acima para realizar a compra da Cesta Pequena por <span className="font-bold">R$ 50,00</span>.</p>
        </div>
      </div>
    </div>
  </div>
