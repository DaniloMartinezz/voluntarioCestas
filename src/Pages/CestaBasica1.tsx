...
const CestaBasica1: React.FC = () => {
  ...
  const paymentCode = '00020126740014br.gov.bcb.pix0136297b95f1-9c1b-40d9-abf3-b7d9d2e90ae00212Cesta Basica520400005303986540550.005802BR5925CENTRO DE ESTUDOS ESPIRIT6008Campinas62290525CENTRODE00000348394960ASA6304324F';
      ...
      <div className="container mx-auto p-4 md:p-10 mt-16">
        <div className="bg-white rounded-lg shadow-lg p-6 md:p-10">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-3xl font-bold text-gray-900">Cesta Básica Pequena</h1>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-10">
            <div className="w-full md:w-1/3">
              <img src={CestaPequena} alt="Cesta Pequena" className="w-full rounded-lg shadow-md" />
            </div>

            <div className="w-full md:w-2/3">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">Resumo da Cesta</h2>
              <p className="text-base text-gray-700 mb-6">
                A Cesta Pequena é ideal para pequenos lares, contendo itens básicos essenciais como arroz, feijão, macarrão, açúcar, café, e óleo.
              </p>
          ...
          <div className="mt-10 bg-gray-100 p-6 rounded-lg shadow-inner">
            ...
            <p className="text-center text-base text-gray-700 mb-4">Utilize o QR Code acima para realizar a compra da Cesta Pequena por <span className="font-bold">R$ 50,00</span>.</p>
