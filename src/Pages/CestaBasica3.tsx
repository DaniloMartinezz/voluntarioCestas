...
const CestaBasica3: React.FC = () => {
  ...
  const paymentCode = '00020126760014br.gov.bcb.pix0136297b95f1-9c1b-40d9-abf3-b7d9d2e90ae00214Cesta Completa5204000053039865406150.005802BR5925CENTRO DE ESTUDOS ESPIRIT6008Campinas62290525CENTRODE00000348395728ASA6304CA37';
      ...
      <div className="container mx-auto p-4 md:p-10 mt-16">
        <div className="bg-white rounded-lg shadow-lg p-6 md:p-10">
          ...
          <div className="mt-10 bg-gray-100 p-6 rounded-lg shadow-inner">
            ...
            <p className="text-center text-base text-gray-700 mb-4">Utilize o QR Code acima para realizar a compra da Cesta Completa por <span className="font-bold">R$ 150,00</span>.</p>
